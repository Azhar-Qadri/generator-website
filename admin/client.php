  ...
  die();
   ...
   if(isset($_GET['type']) && $_GET['type']!=''){
    ...
    if($type=='status'){
      ...
      $update_status="UPDATE `client` SET status='$status' WHERE id='$id'";
                ...
                <div class="b-b mb-10">
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <h1 class="h3 m-0">Client Table</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <section class="boxs ">
                            <div style="margin-left: 85%">
                                ...
                                <a  class="btn btn-raised btn-primary" href="client_manage.php">Add Client</a>
                              </h3>
                            </div>
                        ...
                        if($row['status']==1){
                         ...
                         ?>
                                 ...
                                 <td>
                                    <?php 
                                       echo "<a href='?type=delete&id=".$row['id']."'>Delete</a> | <a href='client_manage.php?type=edit&id=".$row['id']."'>Edit</a>";
                                       
                                      ?>
                                 </td>
                                 <td><?php echo $row['name']; ?></td>
                                 <td><?php echo $row['bio']; ?></td>
                     <td><img width="100px" height="100px" src="media/client/<?php echo $row['image'];?>"/></td>
