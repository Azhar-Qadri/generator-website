  ...
  die();
   ...
   if(isset($_GET['type']) && $_GET['type']!=''){
    ...
    if($type=='status'){
      ...
      $update_status="UPDATE `client_review` SET status='$status' WHERE id='$id'";
    ...
    if($type=='delete'){
      $id=$_GET['id'];
      $delete_sql="DELETE FROM `client_review` WHERE id='$id'";
      mysqli_query($con,$delete_sql);
    }
}

   
   $sql_client_review="SELECT * FROM `client_review`";
   $run_client_review=mysqli_query($con,$sql_client_review);
                ...
                <div class="b-b mb-10">
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <h1 class="h3 m-0">Client Review Table</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <section class="boxs ">
                             <div style="margin-left: 85%">
                                ...
                                <a  class="btn btn-raised btn-primary" href="client_review_manage.php">Add Reviews</a>
                              </h3>
                            </div>
                              ...
                              <?php
                                 $i=1;
                                  while($row=mysqli_fetch_array($run_client_review)){ ?>
                              <tr>
                                 <td><?php echo $i; ?></td>
                                 <td>
                        <?php 
                        if($row['status']==1){
                         ...
                         ?>
                                 ...
                                 <td>
                                    <?php 
                                       echo "<a href='?type=delete&id=".$row['id']."'>Delete</a> | <a href='client_review_manage.php?type=edit&id=".$row['id']."'>Edit</a>";
                                       
                                      ?>
                                 </td>
                                 <td><?php echo $row['name']; ?></td>
                                 <td><?php echo $row['review']; ?></td>
                     <td><img width="100px" height="100px" src="media/client_review/<?php echo $row['image'];?>"/></td>
